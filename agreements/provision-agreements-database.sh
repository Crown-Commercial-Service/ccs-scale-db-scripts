...
psql -h $SERVER -d $DATABASE -p $PORT -U $USERNAME -a -q -f create_commercial_agreement_role_types.sql
...
psql -h $SERVER -d $DATABASE -p $PORT -U $USERNAME -a -q -f create_contact_points.sql
...
psql -h $SERVER -d $DATABASE -p $PORT -U $USERNAME -a -q -f create_lot_organisation_role_types.sql
...
psql -h $SERVER -d $DATABASE -p $PORT -U $USERNAME -a -q -f create_routes_to_market.sql
