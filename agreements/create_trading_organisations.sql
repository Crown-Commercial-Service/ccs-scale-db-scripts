...
INSERT INTO public.trading_organisations(
	trading_organisation_id, organisation_id, trading_organisation_name)
	VALUES (1,(select organisation_id from organisations where legal_name = 'ACS Business Supplies Ltd'), 'ACS Ltd');
