...
ADD CONSTRAINT assessment_submission_types_assessment_tools_fk FOREIGN KEY  (assessment_tool_id)
    REFERENCES assessment_tools (assesment_tool_id);
...
ADD CONSTRAINT assessment_taxons_assessment_tools_fk FOREIGN KEYS (assessmemnt_tool_id)
    REFERENCES assessment_tools (assesment_tool_id);

ALTER TABLE assessment_taxons
ADD CONSTRAINT assessment_taxons_assessment_taxons_fk FOREIGN KEY (assessmemnt_parent_taxon_id)
    REFERENCES assessment_taxons (assesment_taxon_id);
...
ADD CONSTRAINT aupplier_submissions_lot_requirement_taxons_fk FOREIGN KEY (lot_requirement_taxon_id)
...
ADD CONSTRAINT assessment_selection_results_assessment_selections (assessment_selection_id)
