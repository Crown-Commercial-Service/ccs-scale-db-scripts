...
v0.0.3       Inserts GM Lite Journey and the error message needed for Find a Thing UI.
			 Deleting search terms from the list below.
*/
...
-----------------------------------------------------------------------------------------------
--Deleting some search terms and its relationship in the search_domains table


DELETE FROM search_domains 
WHERE  search_id in (SELECT search_id
				    FROM   search_terms
				    WHERE  search_term in ('adaptations',
'archiving',
'audit',
'ava',
'benchmarking',
...
'housing co-operatives housing trusts',
